...
namespace SistemaVenta.BLL.Servicios
{
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoDTO>> Listar()
        {
            try
            {
                var queryProducto= await _productoRepositorio.Listar();
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                var productoEncontrado = await _productoRepositorio.Obtener(pro => pro.IdProducto==productoModelo.IdProducto);
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                var productoEncontrado = await _productoRepositorio.Obtener(pro => pro.IdProducto == id);
